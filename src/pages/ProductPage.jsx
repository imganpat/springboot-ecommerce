...
const ProductPage = () => {
    ...
    const imageUrl = activeImage ? `http://localhost:8080/uploads/images/${activeImage}` : "";
                        ...
                        {imageList.length > 1 && (
                            <>
                                <button
                                    ...
                                    className="absolute left-3 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-lg font-semibold text-gray-700 shadow hover:bg-white"
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/90 text-lg font-semibold text-gray-700 shadow hover:bg-white"
                            ...
                            <div className="absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 gap-2 rounded-full bg-black/20 px-3 py-2 backdrop-blur-sm">
                                {imageList.map((image, index) => (
                                    <button
                                        ...
                                        className={`h-2.5 w-2.5 rounded-full transition ${index === activeImageIndex ? "bg-white" : "bg-white/40"
                                            }`}
                                    />
                                ))}
                            </div>
